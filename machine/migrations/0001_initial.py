    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AnalysisSource_ColumnsNameInput', django_mysql.models.JSONField(blank=True, default=list)),
                ('AnalysisSource_ColumnsNameOutput', django_mysql.models.JSONField(blank=True, default=list)),
                ...
                ('Owner_User_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
